...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-dark navbar-expand-md bg-dark justify-content-center">
      <a href="<?php echo site_url('admin/Admin');?>" class="navbar-brand d-flex w-50 mr-auto">MBI</a>
      ...
      <div class="navbar-collapse collapse w-100" id="collapsingNavbar3">
          <ul class="navbar-nav w-100 justify-content-center">
              ...
              <li class="nav-item">
                  <a class="nav-link" href="<?php echo site_url('admin/AdminJournalController/');?>">Ledger</a>
              </li>
          </ul>
